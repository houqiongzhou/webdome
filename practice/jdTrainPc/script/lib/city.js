...
(function () {
    var citys = Vcity.allCity, match, letter,
        ...
        // reg2 = /^[a-h]$/i, reg3 = /^[i-p]$/i, reg4 = /^[q-z]$/i;
         reg2 = /^[a-d]$/i, reg3 = /^[e-h]$/i, reg4 = /^[i-m]$/i, reg5 = /^[n-t]$/i, reg6 = /^[w-z]$/i;
    if (!Vcity.oCity) {
        // Vcity.oCity = { hot: {}, ABCDEFGH: {}, IJKLMNOP: {}, QRSTUVWXYZ: {} };
        Vcity.oCity = { hot: {}, ABCD: {}, EFGH: {}, IJKLM: {}, NPQRST:{}, WXYZ: {} };
        ...
        for (var i = 0, n = citys.length; i < n; i++) {
            ...
            if (reg2.test(letter)) {
                ...
                if (!Vcity.oCity.IJKLM[letter]) Vcity.oCity.IJKLM[letter] = [];
                Vcity.oCity.IJKLM[letter].push(match[1]);
            } else if (reg5.test(letter)) {
                if (!Vcity.oCity.NPQRST[letter]) Vcity.oCity.NPQRST[letter] = [];
                Vcity.oCity.NPQRST[letter].push(match[1]);
            } else if (reg6.test(letter)) {
                if (!Vcity.oCity.WXYZ[letter]) Vcity.oCity.WXYZ[letter] = [];
                Vcity.oCity.WXYZ[letter].push(match[1]);
            }
